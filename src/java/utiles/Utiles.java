...
public class Utiles {
    ...
    public static java.util.Date stringToUtilDate(String fecha) throws java.text.ParseException {
    ...
    public static java.sql.Date stringToSqlDate(String fecha) throws java.text.ParseException {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        java.util.Date utilDate = new java.util.Date();
